function openBekkedal() {
  createWindow({
    /* room for the 720x450 presentation plus the pane padding, the title bar
       and the app bar. createWindow clamps this to the desktop, so a small
       screen still gets a window that fits — just a smaller picture. */
    kind: 'app', title: 'Bekkedal', w: 748, h: 540,
    build: body => {
